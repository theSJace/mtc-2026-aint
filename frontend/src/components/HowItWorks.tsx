          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="flex md:flex-col items-center gap-3.5 md:gap-0">
                <div
                  className={`w-12.5 h-12.5 md:w-[50px] md:h-[50px] rounded-full flex items-center justify-center font-playfair text-lg font-bold ${
                    index === 0 ? "bg-green-pale text-green-deep" : index === 1 ? "bg-amber-50 text-amber-700" : "bg-red-50 text-red-800"
                  } md:mx-auto md:mb-3.5 flex-shrink-0`}
                >
                  {index + 1}
                </div>
                <div className="flex-1 md:flex-none">
                  <div className="text-2xl mb-2.5 hidden md:block">{["📋", "📱", "✅"][index]}</div>
